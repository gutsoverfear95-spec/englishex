...
-- Nguon: Project Gutenberg #11 (public domain)
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('755e54ce-3eb2-4314-ad1e-d7bddfec4037', '804649e6-99d8-49da-aa41-309bc3a3d846', 1, 'Chapter I. Down the Rabbit-hole', 'Alice was beginning to get very tired of sitting by her sister on the
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('bfac7f56-e7b0-42c9-a784-c5a5e935a1f1', '804649e6-99d8-49da-aa41-309bc3a3d846', 2, 'Chapter II. The Pool of Tears', '“Curiouser and curiouser!” cried Alice (she was so much surprised, that
...
led the way, and the whole party swam to the shore.', 2093)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('216f5cd6-caf8-4c76-aefb-c5937c618db8', '804649e6-99d8-49da-aa41-309bc3a3d846', 3, 'Chapter III. A Caucus-race and a Long Tale', 'They were indeed a queer-looking party that assembled on the bank—the
...
coming back to finish his story.', 1694)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('5ac69c8a-ae5c-4df3-ac83-54b7bb892112', '804649e6-99d8-49da-aa41-309bc3a3d846', 4, 'Chapter IV. The Rabbit Sends in a Little Bill', 'It was the White Rabbit, trotting slowly back again, and looking
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('58d9cab2-ca75-41b1-a27f-a16279da3caf', '804649e6-99d8-49da-aa41-309bc3a3d846', 5, 'Chapter V. Advice from a Caterpillar', 'The Caterpillar and Alice looked at each other for some time in
...
near the house till she had brought herself down to nine inches high.', 2180)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('3699ad17-1bac-48cb-a173-9427be50efd6', '804649e6-99d8-49da-aa41-309bc3a3d846', 6, 'Chapter VI. Pig and Pepper', 'For a minute or two she stood looking at the house, and wondering what
...
I almost wish I’d gone to see the Hatter instead!”', 2588)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('559ff757-29a2-4b7c-a15f-2729d0a86e1e', '804649e6-99d8-49da-aa41-309bc3a3d846', 7, 'Chapter VII. A Mad Tea-party', 'There was a table set out under a tree in front of the house, and the
...
and the cool fountains.', 2282)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('ac781529-a49a-45f2-a6d9-bbd8c472e826', '804649e6-99d8-49da-aa41-309bc3a3d846', 8, 'Chapter VIII. The Queen’s Croquet-ground', 'A large rose-tree stood near the entrance of the garden: the roses
...
while the rest of the party went back to the game.', 2482)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('85de2365-64ab-48c5-a3e7-6dc95c2cc984', '804649e6-99d8-49da-aa41-309bc3a3d846', 9, 'Chapter IX. The Mock Turtle’s Story', '“You can’t think how glad I am to see you again, you dear old thing!”
...
decided tone: “tell her something about the games now.”', 2266)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('75ec94e6-da2f-47fa-a86a-086908329707', '804649e6-99d8-49da-aa41-309bc3a3d846', 10, 'Chapter X. The Lobster Quadrille', 'The Mock Turtle sighed deeply, and drew the back of one flapper across
...
“Soo—oop of the e—e—evening,
    ...
    Beautiful, beautiful Soup!”', 2025)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('f200ee60-29dc-42fc-a049-413726b77292', '804649e6-99d8-49da-aa41-309bc3a3d846', 11, 'Chapter XI. Who Stole the Tarts?', 'The King and Queen of Hearts were seated on their throne when they
...
little voice, the name “Alice!”', 1872)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('c6534edf-298f-4a95-a90c-3b9e6546bfc0', '804649e6-99d8-49da-aa41-309bc3a3d846', 12, 'Chapter XII. Alice’s Evidence', '“Here!” cried Alice, quite forgetting in the flurry of the moment how
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('24d2a5e5-a0c1-48b9-af5d-6e3676a1518d', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 1, 'I. A Scandal in Bohemia (1/3)', 'I.
...
“No legal papers or certificates?”', 2840)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;
