...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('c5805a36-5881-49f6-a955-e745c99b0b2f', '663a6e4f-adba-44b9-a289-a17856cd3409', 8, 'IV (2/2)', 'my coffee!’ Then he went out on the sidewalk, and they shot him three
...
smiled, and so I drew her up again closer, this time to my face.', 2729)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('3097dc29-8e5e-4827-a0e8-f0a9814bdf5e', '663a6e4f-adba-44b9-a289-a17856cd3409', 9, 'V (1/2)', 'When I came home to West Egg that night I was afraid for a moment that
...
leaning from the large central bay, spat meditatively into the', 2113)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('44c25c87-f2a5-4377-aea7-a4618faad133', '663a6e4f-adba-44b9-a289-a17856cd3409', 10, 'V (2/2)', 'garden. It was time I went back. While the rain continued it had
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('72c5482b-d4a0-4ea9-afc8-b8c9d6edc51c', '663a6e4f-adba-44b9-a289-a17856cd3409', 11, 'VI (1/2)', 'About this time an ambitious young reporter from New York arrived one
...
many-keyed commotion, but I felt an unpleasantness in the air, a', 2015)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('1d65bbf7-2c1e-4b0f-a24a-9efc4e76f0e2', '663a6e4f-adba-44b9-a289-a17856cd3409', 12, 'VI (2/2)', 'pervading harshness that hadn’t been there before. Or perhaps I had
...
uncommunicable forever.', 2020)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('790b32cc-1b41-4072-a785-5f948a13a1c0', '663a6e4f-adba-44b9-a289-a17856cd3409', 13, 'VII (1/3)', 'It was when curiosity about Gatsby was at its highest that the lights
...
girl with child.', 2916)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('34ffd389-2ee5-412e-a3e8-2e0f9259929b', '663a6e4f-adba-44b9-a289-a17856cd3409', 14, 'VII (2/3)', '“I’ll let you have that car,” said Tom. “I’ll send it over tomorrow
...
“You two start on home, Daisy,” said Tom. “In Mr. Gatsby’s car.”', 2916)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('630796c2-979f-47b6-a9a6-a31a60aee039', '663a6e4f-adba-44b9-a289-a17856cd3409', 15, 'VII (3/3)', 'She looked at Tom, alarmed now, but he insisted with magnanimous
...
moonlight—watching over nothing.', 2933)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('21d1437c-544d-4bd1-a5db-bc417a9cc15a', '663a6e4f-adba-44b9-a289-a17856cd3409', 16, 'VIII (1/2)', 'I couldn’t sleep all night; a foghorn was groaning incessantly on the
...
corruption—and he had stood on those steps, concealing his', 2261)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('53d0ed05-9076-4d7a-a499-4e6d9a7d2d5f', '663a6e4f-adba-44b9-a289-a17856cd3409', 17, 'VIII (2/2)', 'incorruptible dream, as he waved them goodbye.
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('10dbf252-a9ad-4a07-a3a7-b5a5ca83cf65', '663a6e4f-adba-44b9-a289-a17856cd3409', 18, 'IX (1/2)', 'After two years I remember the rest of that day, and that night and
...
It was a photograph of the house, cracked in the corners and dirty', 2602)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('5b70979a-5983-43a8-a469-539943fbef64', '663a6e4f-adba-44b9-a289-a17856cd3409', 19, 'IX (2/2)', 'with many hands. He pointed out every detail to me eagerly. “Look
