...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('d8705e9f-96ae-48a5-acab-9fb415ea7031', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 2, 'I. A Scandal in Bohemia (2/3)', '“None.”
...
specialist in crime.', 2834)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('4feb4f89-4e87-4240-a3d1-7e5924a5df6a', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 3, 'I. A Scandal in Bohemia (3/3)', 'It was a quarter past six when we left Baker Street, and it still
...
title of _the_ woman.', 2847)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('f25dc07e-21f1-48db-ace2-ccf756373673', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 4, 'II. The Red-headed League (1/3)', 'I had called upon my friend, Mr. Sherlock Holmes, one day in the
...
to have the vacancy after all; but after thinking it over for a few', 3035)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('952a24ba-a578-44db-acf6-88710b5a0b71', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 5, 'II. The Red-headed League (2/3)', 'minutes he said that it would be all right.
...
house in Kensington I thought over it all, from the extraordinary story', 3035)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('04cacbc4-a242-4795-a618-a022fc3fca7e', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 6, 'II. The Red-headed League (3/3)', 'of the red-headed copier of the _Encyclopædia_ down to the visit to
...
as Gustave Flaubert wrote to George Sand.”', 3035)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('87c92983-3581-4203-a2d8-ee8194538fa9', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 7, 'III. A Case of Identity (1/2)', '“My dear fellow,” said Sherlock Holmes as we sat on either side of the
...
to Hosmer. He shall find me ready when he comes back.”', 3482)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('72ba8bb6-0781-44f5-ad8b-71cdb37cbbb6', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 8, 'III. A Case of Identity (2/2)', 'For all the preposterous hat and the vacuous face, there was something
...
much sense in Hafiz as in Horace, and as much knowledge of the world.”', 3493)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('b08dc121-ddbe-43eb-a2c2-abed309e145a', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 9, 'IV. The Boscombe Valley Mystery (1/3)', 'We were seated at breakfast one morning, my wife and I, when the maid
...
vanishing cloth. No, sir, I shall approach this case from the point of', 3200)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('61aa96f0-f4ee-4bbd-a89e-91dbbef4495c', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 10, 'IV. The Boscombe Valley Mystery (2/3)', 'view that what this young man says is true, and we shall see whither
...
covered all tracks for six or eight feet round the body. But here are', 3195)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('b6db906a-4934-4f99-a8ed-3323eaa665ff', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 11, 'IV. The Boscombe Valley Mystery (3/3)', 'three separate tracks of the same feet.” He drew out a lens and lay
...
black cloud which rests upon their past.', 3220)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;
