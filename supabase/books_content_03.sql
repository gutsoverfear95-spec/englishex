...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('9e90c77f-b5cd-4d3e-af27-ca426875b867', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 12, 'V. The Five Orange Pips (1/3)', 'When I glance over my notes and records of the Sherlock Holmes cases
...
known eccentricity, brought in a verdict of ‘suicide.’ But I, who knew', 2438)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('acba89bc-986d-4570-a987-7659b662e13c', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 13, 'V. The Five Orange Pips (2/3)', 'how he winced from the very thought of death, had much ado to persuade
...
then, that a man should keep his little brain-attic stocked with all', 2436)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('24c40a32-a398-44d4-ac56-bc631190e37a', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 14, 'V. The Five Orange Pips (3/3)', 'the furniture that he is likely to use, and the rest he can put away in
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('195a22d4-f62d-49a4-a4d7-4431055ca3fa', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 15, 'VI. The Man with the Twisted Lip (1/3)', 'Isa Whitney, brother of the late Elias Whitney, D.D., Principal of the
...
had on neither collar nor necktie.', 3066)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('36f46896-28bb-4c06-a4e6-17f68f1be462', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 16, 'VI. The Man with the Twisted Lip (2/3)', '“Convinced that something was amiss with him, she rushed down the
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('3e492516-3721-4fc7-ac8a-ade0deaea5dd', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 17, 'VI. The Man with the Twisted Lip (3/3)', '“And you were surprised to see him in Swandam Lane?”
...
Street we shall just be in time for breakfast.”', 3071)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('e4970468-0bf8-4616-a7b8-4c825bec5c46', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 18, 'VII. The Adventure of the Blue Carbuncle (1/3)', 'I had called upon my friend Sherlock Holmes upon the second morning
...
Bradstreet, B division, gave evidence as to the arrest of Horner, who', 2596)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('fa63169d-4042-4122-a835-52f97e9477a2', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 19, 'VII. The Adventure of the Blue Carbuncle (2/3)', 'struggled frantically, and protested his innocence in the strongest
...
man whose disgust is too deep for words. A few yards off he stopped', 2593)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('c910676e-f94e-4ca6-ad23-4fe4084a15a2', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 20, 'VII. The Adventure of the Blue Carbuncle (3/3)', 'under a lamp-post and laughed in the hearty, noiseless fashion which
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('70c3c1b8-8c22-4597-a779-36271dcd82ba', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 21, 'VIII. The Adventure of the Speckled Band (1/3)', 'On glancing over my notes of the seventy odd cases in which I have
...
“Yes, there are nearly always some there.”', 3266)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('6468f233-58f3-44ee-a4d1-b104cc73976d', '8a2ee8ba-fa79-47f3-a660-97e001e7f1fe', 22, 'VIII. The Adventure of the Speckled Band (2/3)', '“Ah, and what did you gather from this allusion to a band—a speckled
...
“Oh! you have seen inside, then?”', 3264)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;
