...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('3a91d31b-c077-43d7-a2e3-daad3de21bff', '09634a45-2244-491f-a154-dcc2f947f8a5', 19, 'Chapter XVIII (2/2)', 'partner she had scarcely replied, before Mr. Collins came up to them,
...
was eclipsed by Mr. Bingley and Netherfield.', 2593)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('cd490b4e-fe37-4868-af79-f6c9f7eb26fc', '09634a45-2244-491f-a154-dcc2f947f8a5', 20, 'Chapter XIX', 'The next day opened a new scene at Longbourn. Mr. Collins made his
...
not be mistaken for the affectation and coquetry of an elegant female.', 1909)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('29adfb1a-0658-45ee-a869-2935f32c0607', '09634a45-2244-491f-a154-dcc2f947f8a5', 21, 'Chapter XX', 'Mr. Collins was not left long to the silent contemplation of his
...
has been at all reprehensible, I here beg leave to apologize.”', 1643)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('48c87280-5bd1-4cd1-ab47-d7969feb683c', '09634a45-2244-491f-a154-dcc2f947f8a5', 22, 'Chapter XXI', 'The discussion of Mr. Collins’s offer was now nearly at an end, and
...
care to have two full courses.', 1998)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('d1e14b54-6733-4814-af43-27c89cfecf6d', '09634a45-2244-491f-a154-dcc2f947f8a5', 23, 'Chapter XXII', 'The Bennets were engaged to dine with the Lucases; and again, during the
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('8a94b5fd-dcc5-4e33-a1ea-649958558b6e', '09634a45-2244-491f-a154-dcc2f947f8a5', 24, 'Chapter XXIII', 'Elizabeth was sitting with her mother and sisters, reflecting on what
...
“I leave it to yourself to determine,” said Mr. Bennet.', 1609)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('710ab350-878d-4e80-adcc-195ab044f53a', '09634a45-2244-491f-a154-dcc2f947f8a5', 25, 'Chapter XXIV', 'Miss Bingley’s letter arrived, and put an end to doubt. The very first
...
Mr. Darcy was condemned as the worst of men.', 1926)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('14dc5a4d-abc1-4018-ab01-5ec7ea32e8c0', '09634a45-2244-491f-a154-dcc2f947f8a5', 26, 'Chapter XXV', 'After a week spent in professions of love and schemes of felicity, Mr.
...
ill-natured boy.', 1514)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('49b37b0e-ad6c-4b19-a2f7-e418da4eab21', '09634a45-2244-491f-a154-dcc2f947f8a5', 27, 'Chapter XXVI', 'Mrs. Gardiner’s caution to Elizabeth was punctually and kindly given on
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('37600067-50d0-4c65-a5a7-d5093ab8469e', '09634a45-2244-491f-a154-dcc2f947f8a5', 28, 'Chapter XXVII', 'With no greater events than these in the Longbourn family, and otherwise
...
insupportable than those of the generality of travellers.”', 1254)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('5048afd8-4975-4a04-a4a1-5af9acdb94fb', '09634a45-2244-491f-a154-dcc2f947f8a5', 29, 'Chapter XXVIII', 'Every object in the next day’s journey was new and interesting to
...
to dine at Rosings the next day.', 1448)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('70e4edfe-723c-4c0d-a011-99fc43131d5b', '09634a45-2244-491f-a154-dcc2f947f8a5', 30, 'Chapter XXIX', 'Mr. Collins’s triumph, in consequence of this invitation, was complete.
...
praise into his own hands.', 2380)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('914a51c1-857e-4d70-ae59-49dba9f799f8', '09634a45-2244-491f-a154-dcc2f947f8a5', 31, 'Chapter XXX', 'Sir William stayed only a week at Hunsford; but his visit was long
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('eceabf84-14ba-4d80-a7ff-48cf3452e653', '09634a45-2244-491f-a154-dcc2f947f8a5', 32, 'Chapter XXXI', 'Colonel Fitzwilliam’s manners were very much admired at the Parsonage,
...
ready to take them all home.', 1552)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('435ca565-f54c-49dc-a579-1e5eb6004262', '09634a45-2244-491f-a154-dcc2f947f8a5', 33, 'Chapter XXXII', 'Elizabeth was sitting by herself the next morning, and writing to Jane,
...
in the church, and his cousin could have none at all.', 1492)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('4e341a66-9c2d-4634-ac2e-9bc7c8c70e16', '09634a45-2244-491f-a154-dcc2f947f8a5', 34, 'Chapter XXXIII', 'More than once did Elizabeth, in her ramble within the park,
...
displeased by her staying at home.', 1854)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;
