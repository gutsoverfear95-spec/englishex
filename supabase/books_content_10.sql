...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('08fb4ff2-bb7c-407c-a680-bfd9e6da5926', '09634a45-2244-491f-a154-dcc2f947f8a5', 49, 'Chapter XLVII (1/2)', '“I have been thinking it over again, Elizabeth,” said her uncle, as they
...
They all exclaimed against such terrific ideas; and Mr. Gardiner, after', 2032)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('ade6be9c-d312-462a-aa95-87319d0019ad', '09634a45-2244-491f-a154-dcc2f947f8a5', 50, 'Chapter XLVII (2/2)', 'general assurances of his affection for her and all her family, told her
...
out even so much as this.”', 2045)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('92207bf3-922b-4a0c-a1a3-037f21f17603', '09634a45-2244-491f-a154-dcc2f947f8a5', 51, 'Chapter XLVIII', 'The whole party were in hopes of a letter from Mr. Bennet the next
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('a5c942a2-f135-4bd7-a60f-27b313fc6397', '09634a45-2244-491f-a154-dcc2f947f8a5', 52, 'Chapter XLIX', 'Two days after Mr. Bennet’s return, as Jane and Elizabeth were walking
...
two hours ago, she felt all the advantages of what they had gained.', 2240)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('c35f710a-680e-4194-a435-a414cc76399d', '09634a45-2244-491f-a154-dcc2f947f8a5', 53, 'Chapter L', 'Mr. Bennet had very often wished, before this period of his life, that,
...
would have been the last object of her wishes.', 2198)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('a2decf84-bfbb-45f6-a73b-cdab634c9cbc', '09634a45-2244-491f-a154-dcc2f947f8a5', 54, 'Chapter LI', 'Their sister’s wedding-day arrived; and Jane and Elizabeth felt for her
...
satisfaction, she had rather be without a confidante.', 2068)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('639ca71e-e766-47e4-acfe-5bbe1d4d1653', '09634a45-2244-491f-a154-dcc2f947f8a5', 55, 'Chapter LII', 'Elizabeth had the satisfaction of receiving an answer to her letter as
...
he hardly knew how to look, and they entered the house.', 3027)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('78825a28-dfe4-4757-a280-afc2dc5ab71c', '09634a45-2244-491f-a154-dcc2f947f8a5', 56, 'Chapter LIII', 'Mr. Wickham was so perfectly satisfied with this conversation, that he
...
of one who had ten thousand a year.', 2933)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('670e9fde-c493-4615-ad84-4e9d8662e28b', '09634a45-2244-491f-a154-dcc2f947f8a5', 57, 'Chapter LIV', 'As soon as they were gone, Elizabeth walked out to recover her spirits;
...
insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('281c7104-533f-4cfe-a7a5-a538490cbf66', '09634a45-2244-491f-a154-dcc2f947f8a5', 58, 'Chapter LV', 'A few days after this visit, Mr. Bingley called again, and alone. His
...
they had been generally proved to be marked out for misfortune.', 2324)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('169614d0-af05-4296-a6ea-ab2132035e4e', '09634a45-2244-491f-a154-dcc2f947f8a5', 59, 'Chapter LVI', 'One morning, about a week after Bingley’s engagement with Jane had been
...
acknowledge the substance of their conversation was impossible.', 2722)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('e27ceb8c-de76-44c4-a90a-1d8fdb14f2bc', '09634a45-2244-491f-a154-dcc2f947f8a5', 60, 'Chapter LVII', 'The discomposure of spirits which this extraordinary visit threw
...
his seeing too _little_, she might have fancied too _much_.', 1650)
on conflict (book_id, number) do update set title = excluded.title, content = excluded.content, word_count = excluded.word_count;

insert into public.book_chapters (id, book_id, number, title, content, word_count) values
  ('d85f8d75-9e8d-4e97-a58c-f73486843634', '09634a45-2244-491f-a154-dcc2f947f8a5', 61, 'Chapter LVIII', 'Instead of receiving any such letter of excuse from his friend, as
